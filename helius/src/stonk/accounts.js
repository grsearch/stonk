...
function mint(a) {
  ...
  return { decimals: b[44], program: a.owner, fees };
}
...
function clmm(a) {
  const b = bytes(a); if (a.owner !== CLMM || b.length < 390 || !b.subarray(0, 8).equals(discriminator('PoolState')) || (b[389] & 16)) throw Error('Invalid CLMM pool');
  ...
  return { mint0: key(b, 73), mint1: key(b, 105), decimals0: b[233], decimals1: b[234],
