...
test('strict graduation window includes zero, excludes 4 hours, unknown and future', () => {
...
test('legacy SOL and live settings cannot enable trading or change 30-minute window', () => {
  ...
  assert.equal(c.dryRun, undefined); assert.equal(c.minSellSol, undefined); assert.equal(WINDOW_MS, 14400000);
